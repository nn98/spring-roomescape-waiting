...
class ReservationControllerTest {
    ...
    void createReservation() throws Exception {
        ...
        performPost("/reservations", new PaymentReservationRequest("브라운", LocalDate.now(), 1L, 1L, 1000L, "pk_test", "order_test"))
    ...
    void createReservationWithInvalidData() throws Exception {
        performPost("/reservations", new PaymentReservationRequest("", LocalDate.now(), 1L, 1L, 1000L, "pk_test", "order_test"))
                .andExpect(status().isBadRequest())
